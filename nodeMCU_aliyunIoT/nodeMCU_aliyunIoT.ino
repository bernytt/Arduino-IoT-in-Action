...
/* 连接您的WIFI SSID和密码 */
#define WIFI_SSID         "替换ssid"
#define WIFI_PASSWD       "替换password"
...
#define BODY_FORMAT     "{\"id\":\"123\",\"version\":\"1.0\",\"method\":\"thing.event.property.post\",\"params\":{\"temperature\":%.1f,\"humidity\":%.1f}}"
